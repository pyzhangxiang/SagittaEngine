//////////////////////////////////////////////////////
// file: sgVector2.h @ 2008-1-20 by Zhang Xiang
...
namespace Sagitta{
	...
	*/
	class _SG_MathExport Vector2{
	// member variables
	private:
        SERIALIZE_BEGIN(Vector2)
		union{
	...
	public:
		...
		*/
		...
		inline _SG_MathExport friend std::ostream& operator << (std::ostream &o, const Vector2 &v){
			o << "Vector2(" << v.x() << "," << v.y() << ")";
			return o;
		}
