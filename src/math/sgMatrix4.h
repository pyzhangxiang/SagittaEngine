//////////////////////////////////////////////////////
// file: sgMatrix.h @ 2008-1-30 by Zhang Xiang
// declares of the class Matrix4
// Matrix4 is a class ...
//////////////////////////////////////////////////////
#ifndef __SGMATRIX4_H__
#define __SGMATRIX4_H__
    ...
    */
	...
	public:
		...
		*/
		...
		inline _SG_MathExport friend std::ostream& operator << (std::ostream& o, const Matrix4& m){
			o << "Matrix4(";
