...
// declare of the class sgAnimaJoint
// sgAnimaJoint is a class ...
//////////////////////////////////////////////////////
#ifndef __SGANIMAJOINT_H__
#define __SGANIMAJOINT_H__
...
namespace Sagitta{
	...
	*/
	class _SG_KernelExport sgAnimaJoint{// : public sgObject{
	// type defines
	protected:
	...
	public:
		sgAnimaJoint(size_t aFrameNum);
		sgAnimaJoint(const StdString &aName, size_t aFrameNum);
		~sgAnimaJoint(void);
