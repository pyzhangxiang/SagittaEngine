//////////////////////////////////////////////////////
// file: sgEntity.h @ 2008-1-31 by Zhang Xiang
// declares of the class sgEntity
// sgEntity is a class ...
//////////////////////////////////////////////////////
...
namespace Sagitta{
	...
	*/
	class _SG_KernelExport sgEntity : public sgRenderable{
	// static members
	protected:
	...
	public:
		...
		sgEntity(uInt aPolyType,
				size_t aVertexNum,
				size_t aPolyNum,
				bool aSmooth = true,
				bool aCounterClockWise = true);

		sgEntity(const StdString& aName, 
				uInt aPolyType,
				size_t aVertexNum,
				size_t aPolyNum,
				bool aSmooth = true,
	...
	public:
		/** Clones this object. Overrides from sgSceneObject. */
		sgSceneObject *clone() const;
	...
	*/
	class _SG_KernelExport SVertex : public sgEntity{
	// member variables
	private:
		Vector3 *m_pPosition;
		Color *m_pColor;
	...
	*/
	class _SG_KernelExport SLine : public sgEntity{
	// enum declares
	public:
		/* for future...
		enum LineMode{
	...
	*/
	class _SG_KernelExport STriangle : public sgEntity{
	// member variables
	private:
		Vector3 *m_pPosData;
		Color *m_pColorData;
