...
public:
    StackWalkerAdapter (const size_t num_discard, size_t total = 2) : 
        StackWalker(StackWalker::RetrieveSymbol | StackWalker::RetrieveLine), // do not use public Microsoft-Symbol-Server
        discard_idx(static_cast<int>(num_discard)+2), mTotal(total), mCount(0) {
