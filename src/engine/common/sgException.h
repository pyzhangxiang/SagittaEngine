...
namespace Sagitta{
	...
	*/
	class _SG_KernelExport sgException : public std::exception{
	public:
		enum ExceptionCode{
	...
	*/
	...
	class _SG_KernelExport sgUnimplementedException : public sgException{
	public:
	...
	class _SG_KernelExport sgFileNotFoundException : public sgException{
	public:
	...
	class _SG_KernelExport sgIOException : public sgException{
	public:
	...
	class _SG_KernelExport sgInvalidStateException : public sgException{
	public:
	...
	class _SG_KernelExport sgInvalidParametersException : public sgException{
	public:
	...
	class _SG_KernelExport sgItemIdentityException : public sgException{
	public:
	...
	class _SG_KernelExport sgInternalErrorException : public sgException{
	public:
	...
	class _SG_KernelExport sgRenderingAPIException : public sgException{
	public:
	...
	class _SG_KernelExport sgRuntimeAssertionException : public sgException{
	public:
...
#ifdef _DEBUG
    #define sgAssert(exp, msg) assert(exp && msg)
#else
    #define sgAssert(exp, msg)
#endif
