//////////////////////////////////////////////////////
// file: SFrameBufferManager.cpp 
// created by zhangxiang on 09-01-15
// define of the class SFrameBufferManager
// SFrameBufferManager is a class ...
//////////////////////////////////////////////////////

// INCLUDES //////////////////////////////////////////
#include "SFrameBufferManager.h"
...
//	SObject(),
	...
	//  [1/15/2009 zhangxiang]
	void SFrameBufferManager::_release(void){
		if(m_pColorBuffer){
	...
	//  [1/15/2009 zhangxiang]
	void SFrameBufferManager::getSliceFromAnother(const SFrameBufferManager &aParentBuffers,
												size_t aLeft, size_t aTop,
												size_t aWidth, size_t aHeight){
		_release();
	...
	//  [1/15/2009 zhangxiang]
	SColorBuffer *SFrameBufferManager::getColorBuffer(void) const{
		return m_pColorBuffer;
	}

	//  [1/15/2009 zhangxiang]
	SDepthBuffer *SFrameBufferManager::getDepthBuffer(void) const{
		return m_pDepthBuffer;
	}

	//  [1/15/2009 zhangxiang]
	SStencilBuffer *SFrameBufferManager::getStencilBuffer(void) const{
		return m_pStencilBuffer;
	}

	//  [1/15/2009 zhangxiang]
	void SFrameBufferManager::clearColor(const Color::GLColor &aValue){
		if(!m_pColorBuffer)
			return ;
	...
	//  [1/15/2009 zhangxiang]
	void SFrameBufferManager::clearDepth(Real aValue){
		if(!m_pDepthBuffer)
			return ;
	...
	//  [1/15/2009 zhangxiang]
	void SFrameBufferManager::clearStencil(int aValue){
		if(!m_pStencilBuffer)
			return ;
	...
	//  [1/15/2009 zhangxiang]
	void SFrameBufferManager::_resize(int aTWidth, int aTHeight){
	...
	size_t SFrameBufferManager::left(void) const{
		if(m_pColorBuffer){
	...
	//  [1/16/2009 zhangxiang]
	size_t SFrameBufferManager::top(void) const{
		if(m_pColorBuffer){
	...
	//  [1/16/2009 zhangxiang]
	size_t SFrameBufferManager::width(void) const{
		if(m_pColorBuffer){
	...
	//  [1/16/2009 zhangxiang]
	size_t SFrameBufferManager::height(void) const{
		if(m_pColorBuffer){
	...
	//  [1/16/2009 zhangxiang]
	size_t SFrameBufferManager::getTopParentWidth(void) const{
		if(m_pColorBuffer){
