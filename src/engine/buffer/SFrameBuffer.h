...
//////////////////////////////////////////////////////
#ifndef __SFRAMEBUFFER_H__
#define __SFRAMEBUFFER_H__
...
namespace Sagitta{
	...
	*/
	class _SagittaExport SFrameBuffer : public SBuffer{
	// member variables
	private:
		/// left-top corner
	 ...
	 */
	class _SagittaExport SColorBuffer : public SFrameBuffer{
	// member variables
	 ...
	 */
	class _SagittaExport SDepthBuffer : public SFrameBuffer{
	// member variables
	 ...
	 */
	class _SagittaExport SStencilBuffer : public SFrameBuffer{
	// member variables
