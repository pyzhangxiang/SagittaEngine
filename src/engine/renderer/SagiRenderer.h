...
namespace Sagitta{
	...
	*/
	...
	// type defines
	protected:
		typedef sg_vector(Vector3) V3List;
		typedef sg_vector(Vector2) V2List;
		typedef sg_vector(Color::GLColor) ColorList;
		typedef sg_vector(Real) RealList;
		typedef sg_list(size_t) IndexList;
		typedef sg_vector(uShort) CountList;

		typedef sg_vector(SagiLight) SagiLightList;
