//////////////////////////////////////////////////////
// file: SViewport.h @ 2008-1-31 by Zhang Xiang
// declares of the class SViewport
// SViewport is a class ...
//////////////////////////////////////////////////////
#ifndef __SVIEWPORT_H__
#define __SVIEWPORT_H__
...
namespace Sagitta{
	...
	*/
	class _SagittaExport SViewport : public SRenderObject{
	// enum declares
	public:
		enum ClearBuffers{
			CB_NON = 0x00,
	...
	private:
		/** constructor
			@remarks Only called by SRenderer::createViewport
			@param
	...
	protected:
		...
		/** Responds for the render target resized.
			@remarks
				Internal method. Only called by SRenderer::resize
			@param
				aWidth
			@param
				aHeight
		...
		*/
		...
		/** Sets my z-order value.
			@remarks Internal method. Only called by SRenderer::setViewportZOrder.
		*/
	...
	public:
		...
		*/
		...
		SCamera *camera(void) const;
		/** Sets a camera to combine to me. */
		void setCamera(SCamera *aCamera);
